!function a(b, c, d) {
    ...
    1: [function (a, b, c) {
        ...
        function d(a, b) {
            var c;
            c = window.XMLHttpRequest ? new XMLHttpRequest : new ActiveXObject("Microsoft.XMLHTTP"), c.open("GET", a, !0), c.onreadystatechange = function () {
                if (200 === c.status && 4 === c.readyState)try {
                    b(null, JSON.parse(c.responseText))
                } catch (a) {
                    b(a, null)
                }
            }, c.send()
    ...
    2: [function (a, b, c) {
        ...
        b.exports = function d(a) {
            function b(a) {
                return a ? void 0 !== a.required && a.required instanceof Array : !1
            }

            if (!b(a))throw new Error("-- OptionsValidator: required options missing");
    ...
    3: [function (a, b, c) {
        ...
        function j(a) {
            for (var b = [], c = 0; c < a.length; c++)g(a[c]) && b.push(i(a[c]));
            return b
        }

        function k(a) {
            return a ? m(r, a, s.searchStrategy, s) : []
        }

        function l(a) {
            s = a || {}, s.fuzzy = a.fuzzy || !1, s.limit = a.limit || 10, s.searchStrategy = a.fuzzy ? p : q
        }

        function m(a, b, c, d) {
            for (var e = [], f = 0; f < a.length && e.length < d.limit; f++) {
                var g = n(a[f], b, c, d);
                g && e.push(g)
            }
            return e
        ...
        function n(a, b, c, d) {
            for (var e in a)if (!o(a[e], d.exclude) && c.matches(a[e], b))return a
        }
        ...
        function o(a, b) {
            ...
            for (var d = 0; d < b.length; d++) {
                var e = b[d];
                !c && new RegExp(a).test(e) && (c = !0)
            }
            return c
        }

        b.exports = {put: d, clear: e, get: f, search: k, setOptions: l};
        var p = a("./SearchStrategies/FuzzySearchStrategy"), q = a("./SearchStrategies/LiteralSearchStrategy"), r = [], s = {};
        s.fuzzy = !1, s.limit = 10, s.searchStrategy = s.fuzzy ? p : q
    }, {"./SearchStrategies/FuzzySearchStrategy": 4, "./SearchStrategies/LiteralSearchStrategy": 5}],
    4: [function (a, b, c) {
        "use strict";
        function d() {
            function a(a) {
                return new RegExp(a.split("").join(".*?"), "gi")
            }

            this.matches = function (b, c) {
                return "string" != typeof b ? !1 : (b = b.trim(), !!a(c).test(b))
            }
        }
    ...
    5: [function (a, b, c) {
        ...
        function d() {
            ...
            this.matches = function (b, c) {
                return "string" != typeof b ? !1 : (b = b.trim(), a(b, c))
            }
        }
    ...
    6: [function (a, b, c) {
        "use strict";
        function d(a) {
            f.pattern = a.pattern || f.pattern, f.template = a.template || f.template, "function" == typeof a.middleware && (f.middleware = a.middleware)
        }

        function e(a) {
            return f.template.replace(f.pattern, function (b, c) {
                var d = f.middleware(c, a[c], f.template);
                return void 0 !== d ? d : a[c] || b
            })
        }

        b.exports = {compile: e, setOptions: d};
        var f = {};
        f.pattern = /\{(.*?)\}/g, f.template = "", f.middleware = function () {
        }
    }, {}],
    7: [function (a, b, c) {
        !function (b, c, d) {
            ...
            function f(a) {
                p.load(a, function (b, c) {
                    b && k("failed to get JSON (" + a + ")"), e(c)
                })
            }

            function g() {
                l.resultsContainer.innerHTML = ""
            }

            function h(a) {
                l.resultsContainer.innerHTML += a
            }

            function i() {
                l.searchInput.addEventListener("keyup", function (a) {
                    g(), a.target.value.length > 0 && j(o.search(a.target.value))
                })
            }

            function j(a) {
                if (0 === a.length)return h(l.noResultsText);
                for (var b = 0; b < a.length; b++)h(n.compile(a[b]))
            }

            function k(a) {
                throw new Error("SimpleJekyllSearch --- " + a)
            }
            ...
            var l = {
                ...
                fuzzy: !1,
                exclude: []
            }, m = ["searchInput", "resultsContainer", "json"], n = a("./Templater"), o = a("./Repository"), p = a("./JSONLoader"), q = a("./OptionsValidator")({required: m}), r = a("./utils");
            b.SimpleJekyllSearch = function (a) {
                var b = q.validate(a);
                b.length > 0 && k("You must specify the following required options: " + m), l = r.merge(l, a), n.setOptions({
                    template: l.searchResultTemplate,
                    middleware: l.templateMiddleware
                }), o.setOptions({fuzzy: l.fuzzy, limit: l.limit}), r.isJSON(l.json) ? e(l.json) : f(l.json)
            }, b.SimpleJekyllSearch.init = b.SimpleJekyllSearch
        }(window, document)
    ...
    8: [function (a, b, c) {
        ...
        function d(a, b) {
            var c = {};
            for (var d in a)c[d] = a[d], void 0 !== b[d] && (c[d] = b[d]);
            return c
        }

        function e(a) {
            try {
                return a instanceof Object && JSON.parse(JSON.stringify(a)) ? !0 : !1
            } catch (b) {
                return !1
            }
        }

        b.exports = {merge: d, isJSON: e}
    }, {}]
}, {}, [7]), function (a, b, c) {
    "use strict";
    var d = b.Modernizr, e = a("body");
    a.DLMenu = function (b, c) {
        ...
        _init: function (b) {
            ...
            this.animEndEventName = c[d.prefixed("animation")] + ".dlmenu", this.transEndEventName = e[d.prefixed("transition")] + ".dlmenu", this.supportAnimations = d.cssanimations, this.supportTransitions = d.csstransitions, this._initEvents()
        }, _config: function () {
            ...
            this.$trigger.on("click.dlmenu", function () {
                ...
                if (e.length > 0) {
                    var f = e.clone().css({opacity: 0, margin: 0}).insertAfter(b.$menu), g = function () {
                ...
                var d = a(this), e = d.parents("ul.dl-submenu:first"), f = e.parent(), g = e.clone().insertAfter(b.$menu), h = function () {
                    b.$menu.off(b.animEndEventName).removeClass(b.options.animationClasses.classin), g.remove()
                };
                return setTimeout(function () {
                    g.addClass(b.options.animationClasses.classout), b.$menu.addClass(b.options.animationClasses.classin), b.supportAnimations ? b.$menu.on(b.animEndEventName, h) : h.call(), f.removeClass("dl-subviewopen");
                    var a = d.parents(".dl-subview:first");
    ...
    a.fn.dlmenu = function (b) {
        if ("string" == typeof b) {
            ...
            this.each(function () {
                ...
                return d ? a.isFunction(d[b]) && "_" !== b.charAt(0) ? void d[b].apply(d, c) : void f("no such method '" + b + "' for dlmenu instance") : void f("cannot call methods on dlmenu prior to initialization; attempted to call method '" + b + "'")
            })
    ...
    function d(b, c) {
        this.element = b, this.settings = a.extend({}, j, c), this._defaults = j, this._name = i, this.init()
    }

    function e(a, d, e, f) {
        var g = b.innerWidth ? b.innerWidth : c.documentElement.clientWidth ? c.documentElement.clientWidth : screen.width, h = b.innerHeight ? b.innerHeight : c.documentElement.clientHeight ? c.documentElement.clientHeight : screen.height, i = g / 2 - e / 2 + 10, j = h / 2 - f / 2 + 50, k = b.open(a, d, "scrollbars=yes, width=" + e + ", height=" + f + ", top=" + j + ", left=" + i);
        k.focus()
    }

    function f(a) {
        return a >= 1e9 ? (a / 1e9).toFixed(1).replace(/\.0$/, "") + "G" : a >= 1e6 ? (a / 1e6).toFixed(1).replace(/\.0$/, "") + "M" : a >= 1e3 ? (a / 1e3).toFixed(1).replace(/\.0$/, "") + "K" : a
    }

    function g(d) {
        var e = b.innerWidth ? b.innerWidth : c.documentElement.clientWidth ? c.documentElement.clientWidth : screen.width;
        961 > e ? a.each(d, function () {
            a(this).css("width", 100 / d.length + "%")
        }) : a.each(d, function () {
    ...
    function h(c, d, e) {
        switch (d = encodeURI(d), c) {
            case"facebook":
                a.get("https://graph.facebook.com/" + d, function (b) {
                    if (b.shares && b.shares > 0) {
                        var c = a("<span>", {"class": "shareCount"});
                        c.append(f(b.shares)), e.append(c), e.find("i").removeClass("m-top5")
                    }
                }, "jsonp");
                break;
            case"twitter":
                a.get("https://urls.api.twitter.com/1/urls/count.json?url=" + d + "&callback=?", function (b) {
                    if (b.count && b.count > 0) {
                        var c = a("<span>", {"class": "shareCount"});
                        c.append(f(b.count)), e.append(c), e.find("i").removeClass("m-top5")
                    }
                }, "jsonp");
                break;
            case"linkedin":
                a.get("https://www.linkedin.com/countserv/count/share?url=" + d + "&callback=?", function (b) {
                    if (b.count && b.count > 0) {
                        var c = a("<span>", {"class": "shareCount"});
                        c.append(f(b.count)), e.append(c), e.find("i").removeClass("m-top5")
                    }
                ...
                break;
            case"pinterest":
                a.get("https://api.pinterest.com/v1/urls/count.json?url=" + d + "&callback=?", function (b) {
                    if (b.count && b.count > 0) {
                        var c = a("<span>", {"class": "shareCount"});
                        c.append(f(b.count)), e.append(c), e.find("i").removeClass("m-top5")
                    }
                ...
                break;
            case"google-plus":
                b.services || (b.services = {}, b.services.gplus = {}), b.services.gplus.cb = function (a) {
                    b.gplusShares = a
                }, a.getScript("http://share.yandex.ru/gpp.xml?url=" + d + "&callback=?", function () {
                    if (b.gplusShares > 0) {
                        var c = a("<span>", {"class": "shareCount"});
                        c.append(f(b.gplusShares)), e.append(c), e.find("i").removeClass("m-top5")
                    }
                });
                break;
            default:
    ...
    a.extend(d.prototype, {
        init: function () {
            var c = this;
            -1 == a.inArray(this.settings.place, l) && (this.settings.place = this._defaults.place);
            var d = a("<div>", {id: "floatingSocialShare"}), f = a("<div>", {"class": this.settings.place});
            f.appendTo(d), a.each(this.settings.buttons, function (b, d) {
                a.each(k, function (b, e) {
                    if (d == b) {
                        var g = a("<a>", {
                            title: c.settings.title,
                            "class": "" + e.className + " pop-upper"
                        }), i = a("<i>", {"class": "m-top5 fa fa-" + d}), j = e.url;
                        return j = j.replace("{url}", c.settings.url).replace("{title}", c.settings.title).replace("{description}", c.settings.description), g.attr("href", j).attr("title", c.settings.text + d).append(i), c.settings.counter === !0 && h(d, c.settings.url, g), f.append(g), !1
                    }
                })
            }), d.appendTo(this.element);
            var i = a(this.element).find(".pop-upper");
            i.on("click", function (b) {
                b.preventDefault(), e(a(this).attr("href"), a(this).attr("title"), c.settings.popup_width, c.settings.popup_height)
            }), g(i), a(b).resize(function () {
                g(i)
            })
        }
    });
    ...
    u.prototype = {
        ...
        } else b.isOpen && b[c].apply(b, Array.prototype.slice.call(arguments, 1)); else v ? d.data("magnificPopup", c) : d[0].magnificPopup = c, b.addGroup(d, c);
        return d
    };
            ...
            initImage: function () {
                ...
                var c = 0, d = a.img[0], e = function (f) {
                    N && clearInterval(N), N = setInterval(function () {
                        return d.naturalWidth > 0 ? void b._onImageHasSize(a) : (c > 200 && clearInterval(N), c++, void(3 === c ? e(10) : 40 === c ? e(50) : 100 === c && e(500)))
                    }, f)
                };
                e(1)
    ...
    a.magnificPopup.registerModule("zoom", {
        options: {
            ...
            initZoom: function () {
                var a = b.st.zoom, c = ".zoom";
                if (a.enabled && b.supportsTransition) {
                    var d, e, f = a.duration, g = function (b) {
        ...
        a[c] = function (a, b, c) {
            ...
            init: function (a) {
                ...
                if (d.hasClass(e.vertical)) {
                    ...
                    if (f.length)return this.openPanel(f.first());
                    d.addClass(e.opened)
                } else {
                    if (b.hasClass(e.current))return;
                    var g = this.$menu.children("." + e.panel), h = g.filter("." + e.current);
                ...
                h.each(function () {
                    var b = a(this), d = b.parent(), g = d.children("a, span").first();
                    if (d.is("." + e.menu) || (d.data(f.sub, b), b.data(f.parent, d)), !d.children("." + e.next).length && d.parent().is("." + e.listview)) {
                        var h = b.attr("id"), i = a('<a class="' + e.next + '" href="#' + h + '" data-target="#' + h + '" />').insertBefore(g);
                        g.is("span") && i.addClass(e.fullsubopen)
                    }
                    if (!b.children("." + e.navbar).length && !d.hasClass(e.vertical)) {
                        if (d.parent().is("." + e.listview))var d = d.closest("." + e.panel); else var g = d.closest("." + e.panel).find('a[href="#' + b.attr("id") + '"]').first(), d = g.closest("." + e.panel);
                        var j = a('<div class="' + e.navbar + '" />');
                        if (d.length) {
                            var h = d.attr("id");
                            ...
                            j.append('<a class="' + e.btn + " " + e.prev + '" href="#' + h + '" data-target="#' + h + '" />').append(a('<a class="' + e.title + '"' + (_url ? ' href="' + _url + '"' : "") + " />").text(g.text())).prependTo(b), c.opts.navbar.add && b.addClass(e.hasnavbar)
                        } else c.opts.navbar.title && (j.append('<a class="' + e.title + '">' + c.opts.navbar.title + "</a>").prependTo(b), c.opts.navbar.add && b.addClass(e.hasnavbar))
                    }
                });
                ...
                h.$body.on(g.click + "-oncanvas", "a[href]", function (d) {
                    var f = a(this), g = !1, i = b.$menu.find(f).length;
                    for (var j in a[c].addons)if (g = a[c].addons[j].clickAnchor.call(b, f, i))break;
                    if (!g && i) {
                        var k = f.attr("href");
                        if (k.length > 1 && "#" == k.slice(0, 1))try {
                            var l = a(k, b.$menu);
                ...
                for (var b in a[c].addons)a[c].addons[b].add.call(this), a[c].addons[b].add = function () {
                };
                for (var b in a[c].addons)a[c].addons[b].setup.call(this)
            }, __api: function () {
                var b = this, c = {};
                return a.each(this._api, function () {
                    var a = this;
                    c[a] = function () {
                        var d = b[a].apply(b, arguments);
    ...
    a[b].addons[c] = {
        setup: function () {
            if (this.opts.offCanvas) {
                ...
                if (this.conf[c], g = a[b].glbl, "boolean" == typeof h && h && (h = {height: "auto"}), "object" != typeof h && (h = {}), h = this.opts[c] = a.extend(!0, {}, a[b].defaults[c], h), "auto" == h.height) {
                    this.$menu.addClass(d.autoheight);
                    var i = function (a) {
                        var b = this.$menu.children("." + d.current);
                        _top = parseInt(b.css("top"), 10) || 0, _bot = parseInt(b.css("bottom"), 10) || 0, this.$menu.addClass(d.measureheight), a = a || this.$menu.children("." + d.current), a.is("." + d.vertical) && (a = a.parents("." + d.panel).not("." + d.vertical).first()), this.$menu.height(a.outerHeight() + _top + _bot).removeClass(d.measureheight)
                    };
                    this.bind("update", i), this.bind("openPanel", i), this.bind("closePanel", i), this.bind("open", i), g.$wndw.off(f.resize + "-autoheight").on(f.resize + "-autoheight", function () {
                        i.call(e)
                    })
                }
            }
    ...
    a[b].addons[c] = {
        setup: function () {
            if (this.opts.offCanvas) {
                ...
                if (this.conf[c], g = a[b].glbl, "boolean" == typeof f && (f = {close: f}), "object" != typeof f && (f = {}), f = a.extend(!0, {}, a[b].defaults[c], f), f.close) {
    ...
    a[b].addons[c] = {
        setup: function () {
            ...
            this.conf[c], g = a[b].glbl, "boolean" == typeof h && (h = {
                add: h,
                update: h
            }), "object" != typeof h && (h = {}), h = this.opts[c] = a.extend(!0, {}, a[b].defaults[c], h), this.bind("init", function (b) {
                this.__refactorClass(a("em", b), this.conf.classNames[c].counter, "counter")
            }), h.add && this.bind("init", function (b) {
                b.each(function () {
                ...
                this.$menu.find("." + d.panel).each(function () {
    ...
    }, a[b].defaults[c] = {add: !1, update: !1}, a[b].configuration.classNames[c] = {counter: "Counter"};
    var d, e, f, g
}(jQuery), !function (a) {
    ...
    a[b].addons[c] = {
        setup: function () {
            ...
            if (this.conf[c], g = a[b].glbl, "boolean" == typeof h && (h = {
                    add: h,
                    fixed: h
                }), "object" != typeof h && (h = {}), h = this.opts[c] = a.extend(!0, {}, a[b].defaults[c], h), this.bind("init", function () {
                    ...
                    switch (h.addTo) {
                        case"panels":
                            ...
                            break;
                        default:
                            var c = a(h.addTo, this.$menu).filter("." + d.panel)
                    }
                ...
                this.$fixeddivider = a('<ul class="' + d.listview + " " + d.fixeddivider + '"><li class="' + d.divider + '"></li></ul>').prependTo(this.$menu).children(), this.bind("openPanel", i), this.bind("init", function (b) {
                    b.off(f.scroll + "-dividers " + f.touchmove + "-dividers").on(f.scroll + "-dividers " + f.touchmove + "-dividers", function () {
                        i.call(e, a(this))
                    })
                })
            }
    ...
    a[c].addons[d] = {
        setup: function () {
            if (this.opts.offCanvas) {
                var f = this, g = this.opts[d], i = this.conf[d];
                if (h = a[c].glbl, "boolean" == typeof g && (g = {open: g}), "object" != typeof g && (g = {}), g = this.opts[d] = a.extend(!0, {}, a[c].defaults[d], g), g.open) {
                    var j, k, l, m, n, o = {}, p = 0, q = !1, r = !1, s = 0, t = 0;
                    switch (this.opts.offCanvas.position) {
                        case"left":
                        case"right":
                    ...
                    switch (this.opts.offCanvas.position) {
                        case"right":
                        case"bottom":
                            o.negative = !0, m = function (a) {
                                a >= h.$wndw[r]() - g.maxStartPos && (p = 1)
                            };
                            break;
                        default:
                            o.negative = !1, m = function (a) {
                                a <= g.maxStartPos && (p = 1)
                            }
                    }
                    switch (this.opts.offCanvas.position) {
                    ...
                    v.on("panstart", function (a) {
                        m(a.center[o.typeLower]), h.$slideOutNodes = n(), q = o.open_dir
                    }).on(o.events + " panend", function (a) {
                        p > 0 && a.preventDefault()
                    }).on(o.events, function (a) {
                        if (j = a["delta" + o.typeUpper], o.negative && (j = -j), j != s && (q = j >= s ? o.open_dir : o.close_dir), s = j, s > g.threshold && 1 == p) {
                            if (h.$html.hasClass(e.opened))return;
                            p = 2, f._openSetup(), f.trigger("opening"), h.$html.addClass(e.dragging), t = b(h.$wndw[r]() * i[r].perc, i[r].min, i[r].max)
                        }
                        2 == p && (k = b(s, 10, t) - ("front" == f.opts.offCanvas.zposition ? t : 0), o.negative && (k = -k), l = "translate" + o.typeUpper + "(" + k + "px )", h.$slideOutNodes.css({
                            "-webkit-transform": "-webkit-" + l,
                            transform: l
                        }))
                    }).on("panend", function () {
                        2 == p && (h.$html.removeClass(e.dragging), h.$slideOutNodes.css("transform", ""), f[q == o.open_dir ? "_openFinish" : "close"]()), p = 0
                    })
                }
            }
        }, add: function () {
            return "function" != typeof Hammer || Hammer.VERSION < 2 ? void(a[c].addons[d].setup = function () {
            }) : (e = a[c]._c, f = a[c]._d, g = a[c]._e, void e.add("dragging"))
        }, clickAnchor: function () {
        }
    }, a[c].defaults[d] = {
        open: !1,
        ...
        threshold: 50,
        vendors: {hammer: {}}
    }, a[c].configuration[d] = {width: {perc: .8, min: 140, max: 440}, height: {perc: .8, min: 140, max: 880}};
    var e, f, g, h
}(jQuery), !function (a) {
    ...
    a[b].addons[c] = {
        setup: function () {
            var e = this, f = this.opts[c];
            if (this.conf[c], g = a[b].glbl, "boolean" == typeof f && (f = {add: f}), "number" == typeof f && (f = {
                    add: !0,
                    visible: f
                ...
                h = h.join(" ");
                var j = function (b) {
                    var c = e.$menu.children("." + d.panel).removeClass(h), g = c.filter("." + d.subopened);
        ...
        setup: function () {
            ...
            if (g = a[b].glbl, "undefined" != typeof f) {
                ...
                a.each(f, function (g) {
                    ...
                    i[k] += l - 1;
                    for (var n = 0, o = j.content.length; o > n; n++) {
                        var p = a[b].addons[c][j.content[n]] || !1;
                        p ? p.call(e, m, j, h) : (p = j.content[n], p instanceof a || (p = a(j.content[n])), p.each(function () {
                            m.append(a(this))
                        }))
                    }
                    var q = Math.ceil(m.children().not("." + d.btn).length / l);
                    q > 1 && m.addClass(d.navbar + "-content-" + q), m.children("." + d.btn).length && m.addClass(d.hasbtns), m.prependTo(e.$menu)
                });
    ...
    }, a[b].configuration[c] = {breadcrumbSeparator: "/"}, a[b].configuration.classNames[c] = {
        panelTitle: "Title",
        panelNext: "Next",
        panelPrev: "Prev"
    };
    ...
    var b = "mmenu", c = "navbars", d = "breadcrumbs";
    a[b].addons[c][d] = function (c, d, e) {
        var f = a[b]._c, g = a[b]._d;
        f.add("breadcrumbs separator"), c.append('<span class="' + f.breadcrumbs + '"></span>'), this.bind("init", function (b) {
        ...
        var h = function () {
            var a = this.$menu.children("." + f.current), b = c.find("." + f.breadcrumbs), d = a.children("." + f.navbar).children("." + f.breadcrumbs);
            b.html(d.html())
        };
        this.bind("openPanel", h), this.bind("init", h)
    }
}(jQuery), function (a) {
    var b = "mmenu", c = "navbars", d = "close";
    a[b].addons[c][d] = function (c) {
        var d = a[b]._c, e = a[b].glbl;
        c.append('<a class="' + d.close + " " + d.btn + '" href="#"></a>');
        var f = function (a) {
            c.find("." + d.close).attr("href", "#" + a.attr("id"))
        };
        f.call(this, e.$page), this.bind("setPage", f)
    }
}(jQuery), function (a) {
    var b = "mmenu", c = "navbars", d = "next";
    a[b].addons[c][d] = function (d) {
        var e = a[b]._c;
        d.append('<a class="' + e.next + " " + e.btn + '" href="#"></a>');
        var f = function (a) {
            a = a || this.$menu.children("." + e.current);
            var b = d.find("." + e.next), f = a.find("." + this.conf.classNames[c].panelNext), g = f.attr("href"), h = f.html();
            b[g ? "attr" : "removeAttr"]("href", g), b[g || h ? "removeClass" : "addClass"](e.hidden), b.html(h)
        };
    ...
    var b = "mmenu", c = "navbars", d = "prev";
    a[b].addons[c][d] = function (d) {
        var e = a[b]._c;
        d.append('<a class="' + e.prev + " " + e.btn + '" href="#"></a>'), this.bind("init", function (a) {
            a.removeClass(e.hasnavbar)
        });
        var f = function () {
            var a = this.$menu.children("." + e.current), b = d.find("." + e.prev), f = a.find("." + this.conf.classNames[c].panelPrev);
            f.length || (f = a.children("." + e.navbar).children("." + e.prev));
            var g = f.attr("href"), h = f.html();
            b[g ? "attr" : "removeAttr"]("href", g), b[g || h ? "removeClass" : "addClass"](e.hidden), b.html(h)
        };
        this.bind("openPanel", f), this.bind("init", f)
    }
}(jQuery), function (a) {
    var b = "mmenu", c = "navbars", d = "searchfield";
    a[b].addons[c][d] = function (c) {
        var d = a[b]._c, e = a('<div class="' + d.search + '" />').appendTo(c);
        "object" != typeof this.opts.searchfield && (this.opts.searchfield = {}), this.opts.searchfield.add = !0, this.opts.searchfield.addTo = e
    }
}(jQuery), function (a) {
    var b = "mmenu", c = "navbars", d = "title";
    a[b].addons[c][d] = function (d, e) {
        var f = a[b]._c;
        d.append('<a class="' + f.title + '"></a>');
        var g = function (a) {
            a = a || this.$menu.children("." + f.current);
            var b = d.find("." + f.title), g = a.find("." + this.conf.classNames[c].panelTitle);
            g.length || (g = a.children("." + f.navbar).children("." + f.title));
            var h = g.attr("href"), i = g.html() || e.title;
            b[h ? "attr" : "removeAttr"]("href", h), b[h || i ? "removeClass" : "addClass"](f.hidden), b.html(i)
        };
        this.bind("openPanel", g), this.bind("init", function () {
            g.call(this)
        })
    }
}(jQuery), !function (a) {
    ...
    a[c].addons[d] = {
        setup: function () {
            ...
            h = a[c].glbl, "boolean" == typeof j && (j = {add: j}), "object" != typeof j && (j = {}), j = this.opts[d] = a.extend(!0, {}, a[c].defaults[d], j), this.bind("close", function () {
                ...
                if (j.add) {
                    switch (j.addTo) {
                        case"panels":
                            ...
                            break;
                        default:
                            var d = a(j.addTo, this.$menu)
                    }
                    d.each(function () {
                        var b = a(this);
                        if (!b.is("." + e.panel) || !b.is("." + e.vertical)) {
                            if (!b.children("." + e.search).length) {
                                var c = k.form ? "form" : "div", d = a("<" + c + ' class="' + e.search + '" />');
                                if (k.form && "object" == typeof k.form)for (var f in k.form)d.attr(f, k.form[f]);
                                d.append('<input placeholder="' + j.placeholder + '" type="text" autocomplete="off" />'), b.hasClass(e.search) ? b.replaceWith(d) : b.prepend(d).addClass(e.hassearch)
                            }
                            if (j.noResults) {
                                var g = b.closest("." + e.panel).length;
                                if (g || (b = i.$menu.children("." + e.panel).first()), !b.children("." + e.noresultsmsg).length) {
                    ...
                    }), j.search && a("." + e.search, this.$menu).each(function () {
                        var c = a(this), d = c.closest("." + e.panel).length;
                        if (d)var h = c.closest("." + e.panel), k = h; else var h = a("." + e.panel, i.$menu), k = i.$menu;
                        var l = c.children("input"), m = i.__findAddBack(h, "." + e.listview).children("li"), n = m.filter("." + e.divider), o = i.__filterListItems(m), p = "> a", q = p + ", > span", r = function () {
                            var b = l.val().toLowerCase();
                            h.scrollTop(0), o.add(n).addClass(e.hidden).find("." + e.fullsubopensearch).removeClass(e.fullsubopen).removeClass(e.fullsubopensearch), o.each(function () {
                                var c = a(this), d = p;
                                (j.showTextItems || j.showSubPanels && c.find("." + e.next)) && (d = q), a(d, c).text().toLowerCase().indexOf(b) > -1 && c.add(c.prevAll("." + e.divider).first()).removeClass(e.hidden)
                            }), j.showSubPanels && h.each(function () {
                                var b = a(this);
                                i.__filterListItems(b.find("." + e.listview).children()).each(function () {
                                    var b = a(this), c = b.data(f.sub);
                                    b.removeClass(e.nosubresults), c && c.find("." + e.listview).children().removeClass(e.hidden)
                                })
                            }), a(h.get().reverse()).each(function (b) {
                                var c = a(this), g = c.data(f.parent);
                                g && (i.__filterListItems(c.find("." + e.listview).children()).length ? (g.hasClass(e.hidden) && g.children("." + e.next).not("." + e.fullsubopen).addClass(e.fullsubopen).addClass(e.fullsubopensearch), g.removeClass(e.hidden).removeClass(e.nosubresults).prevAll("." + e.divider).first().removeClass(e.hidden)) : d || (c.hasClass(e.opened) && setTimeout(function () {
                                    i.openPanel(g.closest("." + e.panel))
                                }, 1.5 * (b + 1) * i.conf.openingInterval), g.addClass(e.nosubresults)))
                            }), k[o.not("." + e.hidden).length ? "removeClass" : "addClass"](e.noresults), this.update()
                        };
                        l.off(g.keyup + "-searchfield " + g.change + "-searchfield").on(g.keyup + "-searchfield", function (a) {
                            b(a.keyCode) || r.call(i)
                        }).on(g.change + "-searchfield", function () {
                            r.call(i)
                        })
                    })
                }
            ...
            e = a[c]._c, f = a[c]._d, g = a[c]._e, e.add("search hassearch noresultsmsg noresults nosubresults fullsubopensearch"), g.add("change keyup")
        }, clickAnchor: function () {
        }
    }, a[c].defaults[d] = {
        add: !1,
    ...
    a[b].addons[c] = {
        setup: function () {
            var e = this, h = this.opts[c];
            this.conf[c], g = a[b].glbl, "boolean" == typeof h && (h = {add: h}), "object" != typeof h && (h = {}), h = this.opts[c] = a.extend(!0, {}, a[b].defaults[c], h), this.bind("init", function (b) {
                if (h.add) {
                    switch (h.addTo) {
                        case"panels":
                            var c = b;
                ...
                if (!this.$indexer && this.$menu.children("." + d.hasindexer).length) {
                    this.$indexer = a('<div class="' + d.indexer + '" />').prependTo(this.$menu).append('<a href="#a">a</a><a href="#b">b</a><a href="#c">c</a><a href="#d">d</a><a href="#e">e</a><a href="#f">f</a><a href="#g">g</a><a href="#h">h</a><a href="#i">i</a><a href="#j">j</a><a href="#k">k</a><a href="#l">l</a><a href="#m">m</a><a href="#n">n</a><a href="#o">o</a><a href="#p">p</a><a href="#q">q</a><a href="#r">r</a><a href="#s">s</a><a href="#t">t</a><a href="#u">u</a><a href="#v">v</a><a href="#w">w</a><a href="#x">x</a><a href="#y">y</a><a href="#z">z</a>'), this.$indexer.children().on(f.mouseover + "-sectionindexer " + d.touchstart + "-sectionindexer", function () {
                        var b = a(this).attr("href").slice(1), c = e.$menu.children("." + d.current), f = c.find("." + d.listview), g = !1, h = c.scrollTop(), i = f.position().top + parseInt(f.css("margin-top"), 10) + parseInt(f.css("padding-top"), 10) + h;
                        c.scrollTop(0), f.children("." + d.divider).not("." + d.hidden).each(function () {
                            g === !1 && b == a(this).text().slice(0, 1).toLowerCase() && (g = a(this).position().top + i)
                        }), c.scrollTop(g !== !1 ? g : h)
                    });
                    var g = function (a) {
                        e.$menu[(a.hasClass(d.hasindexer) ? "add" : "remove") + "Class"](d.hasindexer)
                    };
                    this.bind("openPanel", g), g.call(this, this.$menu.children("." + d.current))
                }
            })
        }, add: function () {
    ...
    a[b].addons[c] = {
        setup: function () {
            var e = this;
            this.opts[c], this.conf[c], g = a[b].glbl, this.bind("init", function (b) {
    ...
    var d, e, f, g
}(jQuery), window.matchMedia = window.matchMedia || function (a, b) {
        "use strict";
    ...
    $(window).scroll(function () {
        ...
        b > 300 ? a.attr("class", "header-menu header-menu-overflow") : a.attr("class", "header-menu header-menu-top")
    })
}), $(document).ready(function () {
    $("#menu").attr("style", ""), $("#menu").mmenu({
        extensions: ["border-full", "effect-zoom-menu", "effect-zoom-panels", "pageshadow", "theme-dark"],
        counters: !0,
        navbars: [{
            position: "bottom",
            content: ["<a class='fa fa-search' href='/search'></a>", "<a class='fa fa-envelope' href='#/'></a>", "<a class='fa fa-twitter' href='#/'></a>", "<a class='fa fa-facebook' href='#/'></a>"]
        }]
    })
}), $(document).ready(function () {
